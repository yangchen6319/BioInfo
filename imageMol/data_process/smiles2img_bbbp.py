...
def main():
    ...
    csv_save_path = os.path.join(args.dataroot, args.dataset, "{}_processed_ac.csv".format(args.dataset))
    ...
    index, smiles, label = df["num"].values, df["smiles"].values, df["p_np"].values
